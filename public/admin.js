...
const fillSettingsForm = (settings) => {
  latestSettings = settings ? { ...settings } : {};
  ...
  if (freeJuiceEnabledInput) freeJuiceEnabledInput.checked = Boolean(settings?.free_juice_enabled);
  if (freeJuiceMinSubtotalInput) {
